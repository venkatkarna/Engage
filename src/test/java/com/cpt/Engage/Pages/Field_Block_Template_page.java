...
public class Field_Block_Template_page extends BaseTest {
	...
	By btnOk = By.xpath("(//div//button[text()='Ok']) [20]");
	...
	By Updatebutton = By.xpath("(//div//button[text()='Update']) [2]");
	 ...
	 * JavascriptExecutor executor = (JavascriptExecutor) driver;
	 * executor.executeScript("arguments[0].click();", sltInputsouce); common.WaitAction();
	 * 
	 * }
	 */
	 ...
	 * editDisplayName.sendKeys("Field DisplayName Edit"); common.WaitAction(); }
	 */
	 ...
	 * 
	 * WebElement btnOk = driver.findElement(OkbuttonDeleteField);
	 * btnOk.click(); }
	 */
